        ...
        <div className="w-full md:w-2/3 flex flex-col space-y-6 text-center">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {[
                ...
                <div className="relative" key={name}>
                  ...
                  />
                  {!formData[name] && (
                    <label className="absolute left-2 top-4 text-gray-400 transition-all text-base peer-placeholder-shown:opacity-100 peer-placeholder-shown:top-4 peer-not-placeholder-shown:opacity-0 peer-not-placeholder-shown:top-2 peer-not-placeholder-shown:text-sm">
                      {label}
                    </label>
                  )}
                  <div className="w-3/4 border-b border-gray-300 mt-1"></div>{" "}
                  {/* Short half gray line */}
                  {errors[name] && (
            ...
            <div className="space-y-2">
              ...
              />
              {!formData.message && (
                <label className="absolute left-2 top-4 text-gray-400 transition-all text-base peer-placeholder-shown:opacity-100 peer-placeholder-shown:top-4 peer-not-placeholder-shown:opacity-0 peer-not-placeholder-shown:top-2 peer-not-placeholder-shown:text-sm"></label>
              )}
